...
/****************************************************/
{
  ...
  countsort_swarm(q, lKeys,   lSorted, (1<<8),  0, 11, TH);
  countsort_swarm(q, lSorted, lTemp,   (1<<8), 11, 11, TH);
  countsort_swarm(q, lTemp,   lSorted, (1<<8), 22, 10, TH);
...
void   *SWARM_malloc(int bytes, THREADED) {
  ...
  return(SWARM_Bcast_cp((char*)ptr, TH));
}
